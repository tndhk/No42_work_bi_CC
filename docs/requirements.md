...
**機能:**
- Dashboardをユーザまたはグループへ共有
- 権限種別: Viewer / Editor / Owner
- 共有ダイアログに「このDashboardが参照しているDataset一覧」を表示
...
**機能:**
- Dashboard閲覧時に権限チェック
- Dashboard編集時にEditor/Owner権限チェック
- Dashboard共有時にOwner権限チェック
