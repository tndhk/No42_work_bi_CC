"""Card repository for DynamoDB operations."""
...
class CardRepository(BaseRepository[Card]):
    ...
    def __init__(self) -> None:
        """Initialize CardRepository with cards table configuration."""
        super().__init__(
            table_name=f"{settings.dynamodb_table_prefix}cards",
            pk_name='cardId',
            model=Card
        )

    async def list_by_owner(self, owner_id: str, dynamodb: Any) -> list[Card]:
        """Retrieve all cards owned by a specific user.
